...
//Which variables/semaphores you need depends on how you decide to code your solution.
 ...
 public static int eastCarWaiting; //This semaphore aims to control eastbound cars.
 public static int westCarWaiting; //This semaphore aims to control westbound cars.
 public static Semaphore eastBoundCar; // This is going to count eastbound cars in waiting state.
 public static Semaphore westBoundCar;// This is going to count westbound cars in waiting state.
 public static int totalCars; //This is going to count total cars.
